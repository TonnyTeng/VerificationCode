...
NSNotificationName const UnitFieldDidBecomeFirstResponderNotification = @"UnitFieldDidBecomeFirstResponderNotification";
NSNotificationName const UnitFieldDidResignFirstResponderNotification = @"UnitFieldDidResignFirstResponderNotification";
#else
NSString *const UnitFieldDidBecomeFirstResponderNotification = @"UnitFieldDidBecomeFirstResponderNotification";
NSString *const UnitFieldDidResignFirstResponderNotification = @"UnitFieldDidResignFirstResponderNotification";
#endif

@interface UnitField () <UIKeyInput>
{
    CGSize _contentSize;
...
- (instancetype)initWithInputUnitCount:(NSUInteger)count {
    if (self = [super initWithFrame:CGRectZero]) {
        NSCAssert(count > 0, @"UnitField must have one or more input units.");
        NSCAssert(count <= 8, @"UnitField can not have more than 8 input units.");
...
- (UIKeyboardType)keyboardType {
    ...
    if (_defaultKeyboardType == KeyboardTypeASCIICapable) {
